VirtualBoxやUbuntu等のバージョン、利用環境の状況によっては、インストール中に表示されるボタンがクリックできないことがあります。

このような場合は、Altキーを押しながらF7キーを押すことで、インストールウィンドウをマウスで動かせるようになります。
Ubuntuのインストールウィンドウの場合、画面の右下にボタンがありますので、適宜動かしてクリックしてください。
